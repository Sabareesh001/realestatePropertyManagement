...
/// <summary>
/// Unit tests for the <see cref="PropertyImageDtoValidator"/> class.
/// </summary>
[TestFixture]
public class PropertyImageDtoValidatorTests
{
    private PropertyImageDtoValidator _validator;
    ...
    public void SetUp()
    {
        _validator = new PropertyImageDtoValidator();
    }

    /// <summary>
    /// Verifies that a valid property image DTO with/without Guid Id passes all validation rules.
    /// </summary>
    [Test]
