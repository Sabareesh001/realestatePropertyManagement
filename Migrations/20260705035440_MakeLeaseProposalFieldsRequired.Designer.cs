...
namespace propertyManagement.Migrations
{
    ...
    [Migration("20260705035440_MakeLeaseProposalFieldsRequired")]
    partial class MakeLeaseProposalFieldsRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("propertyManagement.Models.PropertyImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("propertyManagement.Models.UserVerification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("user_verifications_pkey");
            ...
            modelBuilder.Entity("propertyManagement.Models.UserVerificationDocument", b =>
                {
                    b.Property<Guid>("UserVerificationId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_verification_id");

                    b.Property<Guid>("DocumentId")
                        .HasColumnType("uuid")
                        .HasColumnName("document_id");

                    b.HasKey("UserVerificationId", "DocumentId")
                        .HasName("user_verification_documents_pkey");
            ...
            modelBuilder.Entity("propertyManagement.Models.UserVerificationDocument", b =>
                {
                    b.HasOne("propertyManagement.Models.Document", "Document")
                        .WithMany("UserVerificationDocuments")
                        .HasForeignKey("DocumentId")
                        .IsRequired()
                        .HasConstraintName("user_verification_documents_document_id_fkey");

                    b.HasOne("propertyManagement.Models.UserVerification", "UserVerification")
                        .WithMany("UserVerificationDocuments")
